...
def test_force_pending_order_success():
    """Test successfully forcing a pending order."""
    ...
    try:
        ...
        # Mock Kraken API to return current price
            ...
            with patch.object(dashboard, 'config_manager', config_manager):
                ...
                with patch.object(dashboard, 'get_cached_config') as mock_get_config:
                    ...
                    with dashboard.app.test_client() as client:
                        ...
                        assert data['new_threshold_price'] == 51234.56
                        assert 'trigger on next check' in data['message'].lower()
