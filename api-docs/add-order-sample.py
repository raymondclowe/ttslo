...
# Possible values of order type: [market, limit, iceberg, stop-loss, take-profit, stop-loss-limit, take-profit-limit, 
# trailing-stop, trailing-stop-limit, settle-position]
# please refer to sample output in query-open-orders-sample.py for more details
